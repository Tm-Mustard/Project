...
2. Run [`supabase/schema.sql`](supabase/schema.sql) in the SQL editor. This creates the `profiles` table **and** the `images` Storage bucket with row-level security scoped to each user.
